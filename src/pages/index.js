        ...
        <Layout location={this.props.location} title={siteTitle}>
          ...
          <h2>Project Demos</h2>
            ...
            <div className='grid-container-index'>
              <div>
                <iframe className='demos' width="373" height="210" src="https://www.youtube.com/embed/m9WLhJ9x4ts" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
              <iframe className='demos' width="373" height="210" src="https://www.youtube.com/embed/181d-tg6OPc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
